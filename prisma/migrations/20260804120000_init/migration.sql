...
-- CreateEnum
CREATE TYPE "TableStatus" AS ENUM ('FREE', 'OCCUPIED', 'WAITING_ORDER', 'IN_PREPARATION', 'WAITING_PAYMENT', 'CLOSED');

-- CreateEnum
CREATE TYPE "CategoryType" AS ENUM ('STARTER', 'MAIN_COURSE', 'DRINK');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('CREATED', 'SENT_TO_KITCHEN', 'PREPARING', 'READY', 'DELIVERED', 'CLOSED');
...
-- AddForeignKey
ALTER TABLE "tables" ADD CONSTRAINT "tables_currentWaiterId_fkey" FOREIGN KEY ("currentWaiterId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
